    ...
    public function getFacetList($filter = null)
    {
        ...
        foreach (array_keys($filter) as $field) {
            ...
            foreach ($data as $value => $count) {
                ...
                //if translation should be done (flag -translate) we have
                // to distinguis between
                //a) multi domain (field contains a colon). Then the signature
                // of the translation method differs (domain has to be indicated)
                //b) or simple translation

                $currentSettings['displayText'] = $translateInfo['translate'] ?
                    count($translateInfo['field_domain']) == 1 ?
