...
! function(a) {
    var b = function() {
        ...
        k = function() {
            ...
            function f(c) {
                var d, f, i;
                c = c || {}, c.input || a.error("missing input"), this.isActivated = !1, this.selectHighlighted = !!c.selectHighlighted,  this.autoselect = !!c.autoselect, this.minLength = b.isNumber(c.minLength) ? c.minLength : 1, this.$node = g(c.input, c.withHint), d = this.$node.find(".tt-dropdown-menu"), f = this.$node.find(".tt-input"), i = this.$node.find(".tt-hint"), f.on("blur.tt", function(a) {
                    var c, e, g;
            ...
            return b.mixin(f.prototype, {
                ...
                _onEnterKeyed: function(a, b) {
                    ...
                    c && this.selectHighlighted ? (this._select(c), b.preventDefault()) : this.autoselect && d && (this._select(d), b.preventDefault())
                },
            ...
            initialize: function(c, f) {
                function g() {
                    ...
                    b.each(f, function(a) {
                        ...
                        selectHighlighted: c.selectHighlighted,
                        datasets: f
                    }), i.data(d, h)
                }
